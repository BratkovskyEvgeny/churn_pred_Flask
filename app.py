...
def predict():
    if request.method == 'POST':
        ...
        if prediction==1:
             return render_template('index.html',prediction_text="Жаль, конечно, но клиент покинет банк :(")
        else:
             return render_template('index.html',prediction_text="Ура, клиент остаётся в банке !!! ")
